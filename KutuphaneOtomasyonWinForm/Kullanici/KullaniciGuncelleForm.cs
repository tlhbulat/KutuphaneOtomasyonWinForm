...
namespace KutuphaneOtomasyonWinForm.Kullanici
{
    public partial class KullaniciGuncelleForm : Form
    {
        ...
        //Kütüphaneyi çağırdım
        KutuphaneOtomasyonEntities db = new KutuphaneOtomasyonEntities();

        //Listeleme yapması için kullandım
        ...
        {
            //Her tıklamada değer yazdırmak için yaptım. Ad birinci kolonda olduğu için 1 den başlattım.
        ...
        {
            //kullanıcı seçmek için satır 56 daki kodu kullandım.
